...
def get_categories():
    return render_template('categories.html',Recipies=mongo.db.Recipies.find())
    
@app.route('/view_appetizer')
def view_appetizer():
    return render_template('appetizer.html',Recipies=mongo.db.Recipies.find({'category_name': 'Appetizer'}))
    
@app.route('/view_dessert')
def view_dessert():
    return render_template('dessert.html',Recipies=mongo.db.Recipies.find({'category_name': 'Dessert'}))
    
@app.route('/view_lunch')
def view_lunch():
    return render_template('lunch.html',Recipies=mongo.db.Recipies.find({'category_name': 'Lunch'}))
    
@app.route('/view_maindish')
def view_maindish():
    return render_template('maindish.html',Recipies=mongo.db.Recipies.find({'category_name': 'Main Dish'}))
    
@app.route('/view_sidedish')
def view_sidedish():
    return render_template('sidedish.html',Recipies=mongo.db.Recipies.find({'category_name': 'Side Dish'}))
